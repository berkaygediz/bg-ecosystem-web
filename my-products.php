...
<body>
    ...
    <main>
        ...
        <div class="context profile-item"
            style="margin-top: 2%; background-color: rgba(0, 0, 0, 0.37); border-radius: 1rem;">
            <h1>Orders</h1>
            <?php
        ...
        <div class="context profile-item"
            style="margin-top: 2%; background-color: rgba(0, 0, 0, 0.37); border-radius: 1rem;">
            <?php
            $solidwritinglogcount = mysqli_prepare($checkdb, "SELECT * FROM log WHERE email = ? AND product = 'SolidWriting' LIMIT 15");
            ...
            $products = mysqli_fetch_assoc($result);
            if (mysqli_num_rows($result) > 0) {
                echo "<p style='text-align:center;'><b>BG SolidWriting</b></p>";
                ...
                echo "<p><b>BG SolidWriting</b> - A powerful word processor with a rich text editor.</p>";
                echo "<p><b>SolidWriting has not been activated yet.</b></p>";
            }

            $solidsheetslogcount = mysqli_prepare($checkdb, "SELECT * FROM log WHERE email = ? AND product = 'SolidSheets' LIMIT 15");
            ...
            if (mysqli_num_rows($result) > 0) {
                echo "<br><br><p><b>BG SolidSheets</b></p>";
                echo "<div style='margin-top: 20px; text-align: center;'>";
                echo "<center><h1>Log</h1></center><br>";
                echo "<table width='100%' style='text-align: center;'>";
                echo "<tr style='border-bottom: 1px solid #ccc;color: #FF5043;'>";
                ...
                echo "<br><br><p><b>BG SolidSheets</b> - A powerful table processor with formulas and functions.</p>";
                echo "<p><b>SolidSheets has not been activated yet.</b></p>";
            }
            ?>
        </div>
    </main>
